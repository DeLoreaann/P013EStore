...
namespace P013EStore.MVCUI.Controllers
{
	public class CartController : Controller
	{
		...
		{
			return HttpContext.Session.GetJson<Cart>("Cart") ?? new Cart(); // session a bakıyoruz eğer cart isminde session varsa onu, yoksa yeni bir cart nesnesini döndürüyoruz.
		}
