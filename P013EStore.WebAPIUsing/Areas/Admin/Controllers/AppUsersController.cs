...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class AppUsersController : Controller
    {
        ...
        private readonly string _apiAdres = "https://localhost:7180/api/AppUsers"; // api adresini web api projesini çalıştırdığımızda adres çubuğundan veya her hangi bir controller a istek atarak Request URL kısmından veya web api projesinde Properties altındaki launchSettings.json

        public AppUsersController(HttpClient httpClient)
        {
            _httpClient = httpClient; // nesnenin apiye ulaşması için api projesinin de bu projeyle birlikte çalışıyor olması lazım.
            //aynı anda 2 projeyi çalıştırabilmek için solution a sağ tıklayıp açılan menüden configure startup projects diyip açılan ekranda aynı anda başlatmak istediğimiz projeleri seçiyoruz.
        }
