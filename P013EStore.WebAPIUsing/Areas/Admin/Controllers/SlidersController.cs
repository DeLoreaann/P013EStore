...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        private readonly string _apiAdres = "https://localhost:7180/api/Sliders";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Delete(int id, Slider collection, IFormFile? Image, bool resmiSil)
        {
            try
            {
