...
namespace P013EStore.WebAPI.Controllers
{
    ...
    public class SettingsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<Settings>> GetAsync()
        {
        ...
        [HttpPost]
        public async Task<ActionResult> PostAsync([FromBody] Settings value)
        {
        ...
        [HttpPut]
        public async Task<ActionResult> PutAsync([FromBody] Settings value)
        {
