...
namespace P013EStore.WebAPI.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<int> PostAsync([FromBody] Category value) // data adres çubuğundna vs alınacaksa FromQuery=qerys string ile
        {
        ...
        [HttpPut] //[HttpPut("{id}")] orijinal hali
